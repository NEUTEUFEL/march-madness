...
insert into drafters (name, picks) values
  ('Lucas Neuteufel', '{"South Florida","M-OH/SMU","Texas A&M","Santa Clara","Akron","VCU","BYU","TCU"}'),
  ('Bethanie DeRose', '{"Duke","Arizona","UConn","Illinois","St. John''s","Vanderbilt","Louisville","Penn"}'),
  ('Derek Bratrud', '{"St. John''s","VCU","Akron","Iowa State","Vanderbilt","South Florida","Arizona","UCLA"}'),
  ('Gwen Baer', '{"Duke","Houston","Akron","Vanderbilt","VCU","McNeese","Texas A&M","Ohio State"}'),
  ('Charlie Johnson', '{"Duke","St. John''s","Penn","Houston","Florida","Wisconsin","Texas","Georgia"}'),
  ('Katie Close', '{"M-OH/SMU","Akron","Vanderbilt","North Carolina","Texas A&M","Kansas","Wisconsin","Gonzaga"}'),
  ...
  ('Franco Matticoli', '{"Iowa State","St. John''s","Saint Mary''s","VCU","Akron","Troy","Florida","M-OH/SMU"}'),
  ...
  ('Rob Hunden', '{"Ohio State","Virginia","VCU","Akron","South Florida","Iowa State","Michigan State","Nebraska"}'),
  ('Steven Haemmerle', '{"Missouri","BYU","Louisville","St. John''s","Texas A&M","M-OH/SMU","VCU","Santa Clara"}'),
